...
const EditorPanel = () => {
  ...
  return (
    <div className="w-[320px] bg-white border-l border-gray-200 mr-10 mt-10">
      {/* Title */}
      <div className="mb-4">
        <h2 className="text-lg font-semibold mb-4 ml-3">INSPIRATION</h2>
            ...
            return (
              ...
              >
                <img
                  ...
                  alt={` ${size.name}`}
                  className={` w-full h-15 py-2 p-1 mb-1 border border-gray-200 ${
                    isSelected
